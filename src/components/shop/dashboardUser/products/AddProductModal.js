...
import { createProduct, getAllProduct, uploadImage } from "./FetchApi";
...
const AddProductDetail = ({ categories }) => {
  ...
  const submitForm = async (e) => {
    ...
    let a = await uploadImage(fData.pImage);
    fData.pImage = a.imageIds;
    fData.personId = a.personId;
    try {
  ...
  return (
    <Fragment>
      ...
      > */}
      {/* Makes the add product modal always open */}
      <div
