...
const Category = () => {
    ...
    const fetchData = async () => {
        try {
          let responseData = await Axios.get(apiURL+"/api/category/"+id);
  ...
  return (
    <div>
      ...
      {/* End Navber Section */}
        ...
        <div className='mt-20'><FeaturedProducts /></div>
        <div className='grid grid-cols-2 md:grid-cols-6 mb-40'> 
            {products.map(product => (
                ...
                <Fragment>
                    <div className='flex justify-center'>
                        <div className="relative m-1 border-2 bg-origin-content bg-gray-100 h-56 w-48 md:w-56 rounded-lg drop-shadow-2xl">
                        
                            <img
                                onClick={(e) => history.push(`/products/${product._id}`)}
                                className="w-full h-40 w-36 object-scale-down object-center cursor-pointer p-2 shadow-2xl"
