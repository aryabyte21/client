...
const ReviewForm = (props) => {
  // Height calculated here is used as height of review form
  ...
  return (
    <Fragment>
      ...
      {ratingUserList.includes(isAuthenticate().user._id) ? (
        ...
        <div className="h-screen max-w-screen flex flex-col fixed inset-0 bg-gray-200 z-10 py-64 px-4"
        //  style={height={height}}
        >
          ...
          <div className="space-y-4">
            <div className="flex flex-col">
              ...
              <textarea
                ...
                value={fData.review}
                className="border px-4 py-2 focus:outline-none rounded-lg"
                name="textArea"
                id="textArea"
                cols={30}
                rows={3}
            ...
            <div
              ...
              className="inline-block float-left rounded px-4 py-2 text-white text-center cursor-pointer"
            >
              Cancel
            </div>
            <div
              ...
              style={{ background: "#303031" }}
              className="inline-block float-right rounded px-4 py-2 text-white text-center cursor-pointer"
            >
              Submit
            </div>
          </div>
