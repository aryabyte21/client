...
import { editProduct, getAllProduct, uploadImage } from "./FetchApi";
...
const EditProductModal = (props) => {
  ...
  const submitForm = async (e) => {
    ...
    editformData.pEditImages = await uploadImage(editformData.pEditImages)
    console.log(editformData.pEditImages);
    try {
              ...
              {editformData.pImages ? (
                <div className="flex space-x-1">
                  <img
                    ...
                    src={`${apiURL}/api/photo/get-photo/${editformData.pImages[0]}`}
                    alt="productImage"
                  />
                  <img
                    className="h-16 w-16 object-cover"
                    src={`${apiURL}/api/photo/get-photo/${editformData.pImages[1]}`}
                    alt="productImage"
                  />
                </div>
              ) : (
